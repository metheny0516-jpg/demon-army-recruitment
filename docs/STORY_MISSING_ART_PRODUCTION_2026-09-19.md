...
- `checkpoint.webp`: 石の関所に記録窓口を併設し、巻いた羊皮紙、検査机、遮断棒を描写。
- `temple.webp`: 白い列柱の礼拝堂を避難所として使う状況を、毛布、荷物、水瓶だけで描写。
- `gate.webp`: 魔王城の閉じた木鉄門を、青灰色の夜と抑えた松明光で描写。過剰な邪悪装飾を避けた。
- `camp.webp`: 王国遠征軍の補給拠点として、三列の無地旗、荷馬車、天幕、炊事具を朝霧の中に描写。
- `town.webp`: 門の開いた人間の町と、棚・穀物箱が空になった公共食料庫を描写。
- `capital.webp`: 王都の玉座の間を、使い込まれた青い幕、会議卓の閉じた帳簿、窓外の王都で描写。
