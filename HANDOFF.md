...
9. **サウンドの土台** — 攻撃・被弾・ラウンド開始・シナジー・決着に短い効果音を割り当て、
   ミュートと音量設定を用意する。BGMはその後。自動再生制限と素材ライセンスに注意。

### 低

10. 純粋な単一種族が終盤でまだ苦しい（ゴブリン×5は第8戦6%）
11. 敵の立ち絵はまだ無い（味方は全種そろっている）
12. 当初構想の未着手分: 殿堂入り、モンスター図鑑、シナジー図鑑、実績、装備、施設、複数魔王
