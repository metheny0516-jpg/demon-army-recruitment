...
最終更新: 2026-08-31 / ブランチ `claude/demon-king-recruitment-game-sapqsx`
...
**優先度メモ（2026-08-31）:** オーナーの言う「サウンド」は効果音ではなく**BGM**を指す。
効果音候補の採用は全候補の試聴まで保留し、次のコンテンツ拡充はBGMの方針・実装から始める。
...
9. **BGM** — 次回のコンテンツ拡充で最初に着手する。効果音候補の選定とは別タスク。
...
- 次のコンテンツ拡充は**BGMから**。効果音候補は全候補を試聴してから採用を決める
