...
(async () => {
  ...
  try {
    ...
    assert.equal(result.count, 162);   // 27種×6ポーズ（2026-09-12 ハーピー・ミミック・トロルを追加）
    ...
    console.log(`✓ art coverage: ${enemies.length} enemy entries including variants, 10 roles, all 162 pose images loaded at 512px`);
