...
(async () => {
  ...
  try {
    ...
    assert.equal(result.count, 198);   // 33種×6ポーズ（2026-09-14 首謀者と第二幕の5種を追加）
    ...
    console.log(`✓ art coverage: ${enemies.length} enemy entries including variants, 10 roles, all 198 pose images loaded at 512px`);
