...
for t in daily smoke autoplay mission clear scene cutin effects sound music mormo contrib retry nearmiss softlock resume tier0 reroll eventui casualty; do
  run "$t" DUMMY=1
done
