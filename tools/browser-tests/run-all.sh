...
for t in daily smoke autoplay mission clear scene cutin effects pacing sound music mormo contrib retry nearmiss softlock resume tier0 reroll eventui casualty report records kpi synergy mercenary; do
  run "$t" DUMMY=1
done
