...
for t in first-play daily smoke autoplay mission command recruitment facility clear scene cutin effects spectacle loot-relay vfx-lifecycle battlefield ranged arrival pacing sound music mormo contrib retry nearmiss softlock resume tier0 reroll eventui casualty report records kpi synergy synergy-pool brief feast kingslime; do
  run "$t" DUMMY=1
done
