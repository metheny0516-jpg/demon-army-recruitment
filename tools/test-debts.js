...
Game.oweDebt({ kind: "loyalty_dept", dept: "life", amount: -10, battlesLeft: 1, text: "生活部門" });
...
assert(st2.roster[1].loyalty === 55, "loyalty_dept が対象部門にだけ重なる: " + st2.roster[1].loyalty);
