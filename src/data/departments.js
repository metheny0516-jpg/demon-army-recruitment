...
const FACILITIES = [
  { id: "extortion_ledger", icon: "📒", name: "恐喝帳簿", desc: "会計職か《強欲》《追い剥ぎ》を出撃させ、予約金貨3Gごとに次の味方攻撃+40%（Lv.の回数だけ発火）",
  ...
  { id: "graveyard", icon: "🪦", name: "墓地", desc: "建設部門の死霊術師かアンデッドが、戦死者を骸骨従者として召喚（Lv.の体数まで）",
