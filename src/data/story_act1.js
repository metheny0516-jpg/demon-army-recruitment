...
const STORY_BEATS = [
  {
    ...
    mormo: {
      ...
      text: "おかえりなさいませ、魔王様。……いえ、初めまして、デス。\n"
        + "私はモルモ。前の魔王様のもとで、宰相見習いをしていた者デス。宰相というのは、魔王様の右腕。書類と人事とお金を預かる役目デス。\n"
    ...
    text(st, s) {
      ...
      return `玉座の間。玉座には埃が積もっている。前の魔王が消えてから、誰も座っていなかった。\n`
        ...
        + `モルモ「だから魔王様の最初の仕事は、人を集めることデス。履歴書は集めておきました。……この中から、魔王軍を作るんですか？」`;
    }
  },
  {
  ...
  },
  {
    ...
    mormo: {
      ...
      text: "魔王様、城から古い地図を持ってきました。\n"
        ...
        + "これからの作戦会議では、魔王城に隣り合う場所から順に選べます。人間の土地は『落とす』、魔族の土地は『従える』。\n"
        + "……印、思ったより多いデスね。"
    },
    cast(st, h) {
      const a = h.asker();
