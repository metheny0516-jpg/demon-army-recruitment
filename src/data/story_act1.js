...
const KINGDOM_CAST = {
  brennan: {
    ...
    lines: {
      intro: ["命令には、この村に盗賊がいると書いてある。村の中を調べるまで、囲みは解かん！", "王国軍開拓保護隊、伍長ブレンダン。令状に従い、包囲を継続する"],
  ...
  vissel: {
    ...
    lines: {
      intro: ["約束をした王は亡くなり、前の魔王もいない。いまの王は、その約束を引き継がないと決めたのです", "新しい魔王殿？ 存じ上げません。署名がございませんので"],
  ...
  },
  {
    ...
    text(st, s) {
      ...
      return `泥だらけのゴブリンが、門をくぐってきた。走り通しだったらしく、膝が笑っている。\n`
        ...
        + `使いは、村で聞いた兵隊たちのやり取りを話した。\n`
        + `伍長ブレンダン「命令には、この村に盗賊がいると書いてある。村の中を調べるまで、囲みは解かん！」\n`
  ...
  },
  {
    ...
    text(st, s) {
      ...
      return head
        ...
        + `モルモ「北の鉱山では、働いている人たちが帰してもらえないそうデス。城へ戻って、助けに行く準備をしましょう」`;
    },
    html: "map"
  },
  {
  ...
  },
  {
    ...
    text(st, s) {
      ...
      return `王都。玉座の間。国王は逃げなかった——正確には、逃げる前に帳簿を閉じていた。\n`
        ...
        + (oldest ? `${oldest}が、玉座の間の隅に立っている。いまの軍で、いちばん長く仕えている。\n` : "")
