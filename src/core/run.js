...
const Game = {
  ...
  // 測って決めた（docs/SPEC_TRIAL_BATTLE_2026-09-18.md §6、node tools/sim.js 10）。
  // 仕様書の 1.25 / 1.12 では 段3 の勝率が 38% で狙い（30%未満）に届かなかったので、
  // 伸びだけ 1.12 → 1.22 に上げた。段0 63%／段3 24%／best 平均 3.5段。
